...
#ifdef LLVM38
// Copied from llvm/lib/Transforms/Utils/CloneFunction.cpp
...
#ifdef LLVM38
// Copied from llvm/lib/Transforms/Utils/CloneModule.cpp adding the bits
// to copy debug info as well.
